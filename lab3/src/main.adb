...
procedure Main is
   ...
   procedure Starter (Storage_Size, Item_Numbers : Integer; ProdusersConsumers : in Integer) is
      Storage : List;
      ...
      Producers : Producer_Array(1 .. ProdusersConsumers);
      Consumers : Consumer_Array(1 .. ProdusersConsumers);
   begin
      null;
   end Starter;
begin
